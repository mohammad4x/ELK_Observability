...
| Stage | Lesson | Open the code |
| --- | --- |
| 00 | [Orientation: monitoring vs investigation](course/00-orientation/README.md) | [`00-Orientation.slnx`](course/00-orientation/00-Orientation.slnx) |
| 01 | [Opaque system: something failed](course/01-opaque-system/README.md) | [`01-Opaque-System.slnx`](course/01-opaque-system/01-Opaque-System.slnx) |
| 02 | [Queryable logs](course/02-queryable-logs/README.md) | [`02-Queryable-Logs.slnx`](course/02-queryable-logs/02-Queryable-Logs.slnx) |
| 03 | [Business operation and causation](course/03-business-operation/README.md) | [`03-Business-Operation.slnx`](course/03-business-operation/03-Business-Operation.slnx) |
| 04 | [Execution structure and traces](course/04-execution-structure/README.md) | [`04-Execution-Structure.slnx`](course/04-execution-structure/04-Execution-Structure.slnx) |
| 05 | [System symptoms and metrics](course/05-system-symptoms/README.md) | [`05-System-Symptoms.slnx`](course/05-system-symptoms/05-System-Symptoms.slnx) |
| 06 | [OpenTelemetry pipeline](course/06-telemetry-pipeline/README.md) | [`06-Telemetry-Pipeline.slnx`](course/06-telemetry-pipeline/06-Telemetry-Pipeline.slnx) |
| 07 | [Complete investigation](course/07-complete-investigation/README.md) | [`07-Complete-Investigation.slnx`](course/07-complete-investigation/07-Complete-Investigation.slnx) |

See [course/README.md](course/README.md) for the shared code layout and the
presentation flow. Each stage owns its explanation, AppHost source, and
solution in one folder; shared services remain under `src/`.
