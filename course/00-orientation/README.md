...
Open [`01-Opaque-System.slnx`](../01-opaque-system/01-Opaque-System.slnx) and
run two bookings close together. The opaque logs show why plain messages are
not enough to identify one failed operation.
